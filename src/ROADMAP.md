...
- [ ] **Enhanced Persistence & Data Management**
    - [x] Migrate from `localStorage` to `IndexedDB` for larger storage capacity.
    - [x] Implement chunked codebase storage (store files individually).
    - [x] Add project export/import (JSON/ZIP format).
    - [ ] Implement auto-save with conflict resolution for multi-tab usage.
- [x] **Streaming AI Responses**
    - [x] Use Genkit streaming to show responses token-by-token.
    - [x] Add a "stop generation" button.
    - [x] Show typing indicator per-agent.
    - [x] Display partial markdown as it arrives.
- [x] **Codebase Intelligence Upgrade**
    - [x] Implemented initial analysis on project creation.
...
- [x] **Orchestrator Transparency**
    - [x] Show the Orchestrator's reasoning in the UI for why it chose a specific agent.

## 💡 Medium-Impact Improvements

- [ ] **Visual Workflow Tracking**
    - [ ] Show users where they are in the development cycle (e.g., Discovery -> Architecture -> Implementation).
- [ ] **Search & Filtering**
...
- [ ] **Markdown Rendering**
    - [x] Render code blocks with syntax highlighting, tables, and other markdown features in agent responses.
- [ ] **Keyboard Shortcuts**
